...
PMs, writers, and content strategists, here is your process for creating the hihg-impact demo videos about your model-driven apps in Dynamics 365 (formerly called Customer Engagement apps) and Power Platform apps and features. These videos are technical, how-tos to  create a full experience for readers of the product documentation on the [Dynamics 365 Docs site](https://docs.microsoft.com/en-us/dynamics365/). To see contacts for other areas in BAG, see the last section in this article.
