---
title: When to update the ms.date metadata
ms.date: 08/31/2020
ms.service: 
ms.topic: article
author: renwe
...
Do update ms.date if you make significant changes to an existing topic. Significant changes include when you: 
...
Do NOT update ms.date if you’ve made minor topic changes. Minor changes include when you:
